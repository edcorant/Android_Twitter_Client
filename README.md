...
**Twiter Client** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='http://g.recordit.co/pelrIL4DAi.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
<img src='http://g.recordit.co/cCl2imDV4C.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
